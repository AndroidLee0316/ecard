...
public class SimpleCardView extends FrameLayout{
    ...
    public SimpleCardView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        View view = LayoutInflater.from(context).inflate(R.layout.pasc_ecard_simple_card_view,this);
        initView(view);
        defaultBg = R.drawable.pasc_ecard_retation_bg_default;
    }

    private void initView(View view){
        mBgIV = view.findViewById(R.id.pasc_ecard_simple_card_view_bg_iv);
        mNameTV = view.findViewById(R.id.pasc_ecard_simple_card_view_name_tv);
        mDescTV = view.findViewById(R.id.pasc_ecard_simple_card_view_desc_tv);
    }
